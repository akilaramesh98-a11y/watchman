    ...
    {ShipmentCheckDialog}  
              ...
              <div className="body flex flex-col gap-[16px]">
                ...
                <div className=" h-[450px] overflow-y-scroll">
                  <table className="w-full">
                    ...
                    <tbody>
                      {checklistsLIBA.map((item:any, index:any) => (
                          ...
                          <td className="text-center px-3">
                            ...
                            {index == 1 && (
                              <Checkbox
                                ...
                                checked={item.allowed}
                                disabled={
                                  !item.images.some((image: any) => image.imgType === "back-right" && image.imageURL && typeof image.imageURL === 'string')
                                }
                                onChange={(e) => {
                                  setChecklistsLIBA((prev: any) => {
                                    const newChecklists = [...prev];
      ...
      {isUploadPopupOpen && (
        <UploadPopUp
          ...
          updateList={setChecklistsLIBA}
          questionList={checklistsLIBA}
